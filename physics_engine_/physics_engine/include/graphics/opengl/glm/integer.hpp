...
namespace glm
{
	...
	/// Adds 32-bit unsigned integer a and b, returning the sum
	...
	/// Subtracts the 32-bit unsigned integer b from a, returning
	/// the difference if non-negative, or pow(2, 32) plus the difference
	/// otherwise. The value borrow is set to 0 if a >= b, or to 1 otherwise.
	///
	/// @tparam L An integer between 1 and 4 included that qualify the dimension of the vector.
	///
	...
	/// Multiplies 32-bit integers a and b, producing a 64-bit
