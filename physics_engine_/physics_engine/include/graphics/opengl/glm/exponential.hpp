...
namespace glm
{
	...
	/// Returns the natural exponentiation of a, i.e., e^a.
	///
	...
	/// returns the value b which satisfies the equation a = e^b.
	...
	/// Returns the base 2 log of a, i.e., returns the value b,
	/// which satisfies the equation a = 2 ^ b.
	///
