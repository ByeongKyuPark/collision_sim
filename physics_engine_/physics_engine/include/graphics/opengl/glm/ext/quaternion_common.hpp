...
namespace glm
{
	...
	/// The interpolation is oriented and the angularVelocity is performed at constant speed.
	...
	///
	/// @see - slerp(qua<T, Q> const& a, qua<T, Q> const& b, T const& a)
	...
	/// Spherical linear interpolation of two quaternions.
	/// The interpolation always take the short path and the angularVelocity is performed at constant speed.
	///
	/// @param a A quaternion
	/// @param b A quaternion
	/// @param a Interpolation factor. The interpolation is defined beyond the range [0, 1].
    ...
    /// Spherical linear interpolation of two quaternions with multiple spins over angularVelocity axis.
